...
public class VerificadorDePersonalidades {
	...
	private Personalidades dercobrirPersonalidade(String personalidade) {
		...
		if(personalidade.equals("Arquiteto")) {
        	Personalidades personalidades =  new Arquiteto();
			return personalidades;
        }else if(personalidade.equals("Comandante")) {
        	Personalidades personalidades =  new Comandante();
			return personalidades;
        }else if(personalidade.equals("L�gico")) {
        	Personalidades personalidades =  new Logico();
			return personalidades;
        }else if(personalidade.equals("Inovador")) {
        	Personalidades personalidades =  new Inovador();
			return personalidades;
        }else if(personalidade.equals("Protagonista")) {
        	Personalidades personalidades =  new Protagonista();
			return personalidades;
        }else if(personalidade.equals("Advogado")) {
        	Personalidades personalidades =  new Advogado();
			return personalidades;
        }else if(personalidade.equals("Mediador")) {
        	Personalidades personalidades =  new Mediador();
			return personalidades;
        }else if(personalidade.equals("Ativista")) {
        	Personalidades personalidades =  new Ativista();
			return personalidades;
        }else if(personalidade.equals("Log�stico")) {
        	Personalidades personalidades =  new Logistico();
			return personalidades;
        }else if(personalidade.equals("Executivo")) {
        	Personalidades personalidades =  new Executivo();
			return personalidades;
        }else if(personalidade.equals("Defensor")) {
        	Personalidades personalidades =  new Defensor();
			return personalidades;
        }else if(personalidade.equals("C�nsul")) {
        	Personalidades personalidades =  new Consul();
			return personalidades;
        }else if(personalidade.equals("Virtuoso")) {
        	Personalidades personalidades =  new Virtuoso();
			return personalidades;
        }else if(personalidade.equals("Empres�rio")) {
        	Personalidades personalidades =  new Empresario();
			return personalidades;
        }else if(personalidade.equals("Aventureiro")) {
        	Personalidades personalidades =  new Aventureiro();
			return personalidades;
        }else if(personalidade.equals("Animador")) {
        	Personalidades personalidades =  new Animador();
			return personalidades;
        }else {
        	Personalidades personalidades =  new Robo();
        	return personalidades;
        }
